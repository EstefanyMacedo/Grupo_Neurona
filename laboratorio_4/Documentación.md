...
Según Vikanda et al. [8] es posible que las mediciones de ECG contengan diferentes ruidos, como la interferencia de la línea de alimentación (7), la desviación de la línea de base (BW), los artefactos musculares (MA) y los artefactos de movimiento de los electrodos (EM). Al comparar la FFT de su señal sinusal normal con ruido EM con nuestra FFT, notamos que era el ruido que tenía mayor similitud.
 <p align="center">
